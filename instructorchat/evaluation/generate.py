...
def generate_from_docs(docs_dir: str = "documents", save_dir: str = "eval_data") -> None:
    ...
    """
    synthesizer = Synthesizer(max_concurrent=10, model="gpt-4o-mini")
...
def generate_from_pdfs_visual(batch_job: bool = False, pdfs_dir: str = "documents", save_dir: str = "eval_data") -> None:
...
def main():
    ...
    generate_from_pdfs_visual(batch_job=args.batch, pdfs_dir=args.input_dir, save_dir=args.output_dir)
